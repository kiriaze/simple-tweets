...
if ( ! class_exists( 'SimpleTweets' ) ) :
    ...
    class SimpleTweets {
        ...
        public function __construct( array $settings ) {
            ...
            //  Delete cache
            register_deactivation_hook( __FILE__, array( &$this, 'delete_transient') );

            //  Display Cached HTML, update transients
         ...
         * 
         * @return SimpleTweets Instance of self for method chaining
         */
        ...
        public static function display_cached_content() {
            ...
            if ( false === ( $html = get_transient($transient_label) ) ) {
                ...
                $twitter = new SimpleTweets($settings);
                ...
                set_transient( $transient_label, $html, cache );
    ...
    //Make Twitter's link a little nicer
